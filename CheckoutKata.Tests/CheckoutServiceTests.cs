...
namespace CheckoutKata.Tests
{
    ...
    public class Tests
    {
        ...
        [Test]
        public void Given_Basket_Is_Empty_When_GetTotalPrice_Invoked_Then_Zero_Is_Returned()
        {
        ...
        [Test]
        public void Given_Basket_Has_One_Item_When_GetTotalPrice_Invoked_Then_Correct_Total_Is_Returned()
        {
        ...
        [Test]
        public void Given_Basket_Has_Multiple_Non_MultiBuy_Items_When_GetTotalPrice_Is_Invoked_Then_Correct_Total_Is_Returned()
        {
        ...
        [Test]
        public void Given_Basket_Has_MultiBuy_Items_When_GetTotalPrice_Is_Invoked_Then_Correct_Total_Is_Returned()
        {
        ...
        [TestCase(new string[] { "A", "A", "A", "A", "A", "A", "B", "B", "C", "D" }, 340)]
